    ...
    <div class="container relative">
        <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
            <div class="lg:col-span-8 md:col-span-7">
                ...
                <h4 class="text-2xl font-medium mt-6 mb-3"> <?php echo e($ad->title); ?></h4>
                <span class="text-slate-400 flex items-center"><i data-feather="map-pin" class="size-5 me-2"></i> <?php echo e($ad->address); ?></span>
                ...
                <ul class="py-6 flex items-center list-none">
                    ...
                    <li class="flex items-center lg:me-6 me-4">
                        ...
                        <span class="lg:text-xl"><?php echo e($ad->rooms); ?> xona</span>
                    </li>
                ...
                <p class="text-slate-400"><?php echo e($ad->description); ?></p>
            ...
            <div class="lg:col-span-4 md:col-span-5">
                <div class="sticky top-20">
                    <div class="rounded-md bg-slate-50 dark:bg-slate-800 shadow dark:shadow-gray-700">
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center mt-4">
                                ...
                                <span class="text-xl font-medium"><?php echo e($ad->price); ?></span>
                            </div>
                            ...
                            <ul class="list-none mt-4">
                                <li class="flex justify-between items-center mt-2">
                                    ...
                                    <span
                                        class="bg-green-600/10 text-green-600 text-sm px-2.5 py-0.75 rounded h-6"> <?php echo e($ad->status_id); ?></span>
                                </li>
                        ...
                        <div class="flex">
                            <div class="p-1 w-1/2">
                                <a href="" class="btn bg-green-600 hover:bg-green-700 text-white rounded-md w-full">Band
                                    qilish</a>
                            </div>
                            <?php
                                try {
                                    ...
                                    <form action="/bookmark/save" method="POST" class="inline-block">
                                        ...
                                        <div class="p-1 w-1/2">
                                            <a href="/user/saved/ads"
                                               class="btn bg-green-600 hover:bg-green-700 text-white rounded-md w-full">Save</a>
                                        </div>
                                    </form>
                                <?php else: ?>
                                    <form action="/bookmark/delete" method="POST" class="inline-block">
                                        ...
                                        <input type="hidden" name="user_id" value="<?php echo e(Auth::user()->id); ?>">
                                        <div class="p-1 w-1/2">
                                            <a href="/user/saved/ads/remove"
                                               class="btn bg-red-600 hover:bg-red-700 text-white rounded-md w-full">
                                                Discard
                                            </a>
                                        </div>
                                    </form>
                    ...
                    <div class="mt-12 text-center">
                        <h3 class="mb-6 text-xl leading-normal font-medium text-black dark:text-white">E'lon beruvchi
                            bilan boglanish</h3>
...
<?php /**PATH /var/www/resources/views/ads/show.blade.php ENDPATH**/ ?>