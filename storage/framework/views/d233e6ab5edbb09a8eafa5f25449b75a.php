...
<div class="flex gap-2 items-center">
    <span class="w-4 h-4 rounded-sm" style="background-color: <?php echo e($color); ?>"></span>
    <span> <?php echo $color ?? ''; ?> </span>
</div>
<?php /**PATH /var/www/vendor/moonshine/moonshine/resources/views/components/color.blade.php ENDPATH**/ ?>