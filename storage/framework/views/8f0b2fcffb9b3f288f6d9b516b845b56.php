...
<div <?php echo e($attributes->class(['box', 'box-dark' => $dark])); ?>>
    <?php if(($title ?? false) || ($icon ?? false)): ?>
        <h2 class="box-title">
            <?php if($icon ?? false): ?>
...
<?php /**PATH /var/www/vendor/moonshine/moonshine/src/Providers/../../resources/views/components/box.blade.php ENDPATH**/ ?>