...
<a <?php echo e($attributes->class(['inline-flex items-center gap-1 text-2xs hover:text-primary', 'text-primary' => $filled])); ?>>
    <?php if($icon): ?>
...
<?php $component = MoonShine\Components\Badge::resolve(['color' => 'primary'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /var/www/vendor/moonshine/moonshine/resources/views/components/link-native.blade.php ENDPATH**/ ?>