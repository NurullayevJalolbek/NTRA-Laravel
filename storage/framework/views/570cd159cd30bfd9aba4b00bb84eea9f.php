...
<button @click.prevent="copy('<?php echo e($extension->getValue()); ?>')"
        <?php echo e($attributes->class(['expansion'])); ?>

        type="button"
        x-data="tooltip('<?php echo e(__('moonshine::ui.copied')); ?>', {placement: 'top', trigger: 'click', delay: [0, 800]})"
>
...
<?php $component = MoonShine\Components\Icon::resolve(['icon' => 'heroicons.outline.clipboard','size' => '4'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
