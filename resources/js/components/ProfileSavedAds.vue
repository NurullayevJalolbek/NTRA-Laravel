<template>
    ...
    <div class="flex space-x-4">
        <button id="myAdsButton" @click.prevent="UserCreatedAds"
        ...
        <button id="savedAdsButton" @click.prevent="UserSaved"
                class="flex items-center py-1 px-4 dark:text-white/70 hover:text-green-600 dark:hover:text-white">
    ...
    <!--                </ul>-->
    <!--            </div>-->
    <!--        </div>&lt;!&ndash;end property content&ndash;&gt;-->
