                        ...
                        <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                            <div class="md:text-start text-center z-1">
                                <h3 class="md:text-3xl text-2xl md:leading-normal leading-normal font-medium text-black dark:text-white">
                                    Yangiliklarga obuna bo'ling!</h3>
                                <p class="text-slate-400 max-w-xl mx-auto">Eng so'nggi yangiliklar va ma'lumotlar uchun obuna bo'ling.</p>
                            </div>
            ...
            <div class="grid md:grid-cols-2 items-center gap-6">
                <div class="md:text-start text-center">
                    <p class="mb-0 text-gray-300">©
                        ...
                        Hously. <i class="mdi mdi-heart text-red-600"></i> bilan ishlab chiqilgan <a
